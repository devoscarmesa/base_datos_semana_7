...
DROP TABLE IF EXISTS bodega_1;
CREATE TABLE `bodega_1` (
  `IDBodega` VARCHAR(8) NOT NULL PRIMARY KEY,
  `nombreArticulo` varchar(50) NOT NULL,
  `fechaAlmacenamiento` date NOT NULL,
  `cantidad` int(10) NOT NULL,
  `nitEmpresaImportadora` varchar(15) NOT NULL,
  `correoEmpresaImportadora` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (1, 'Real Estate Investment Trusts', '2020-07-10', 1, '64370-375', 'abeecham0@nytimes.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (2, 'Savings Institutions', '2020-04-11', 2, '66689-898', 'obillows1@clickbank.net');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (3, 'Real Estate Investment Trusts', '2020-03-03', 3, '55714-4504', 'lmartinie2@gnu.org');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (4, 'Forest Products', '2019-12-06', 4, '65517-2018', 'jfurney3@addthis.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (5, 'Finance: Consumer Services', '2020-03-09', 5, '11523-7216', 'jmoreing4@webmd.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (6, 'Major Pharmaceuticals', '2020-06-17', 6, '58118-0658', 'ecabera5@webnode.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (7, 'n/a', '2020-07-21', 7, '42043-321', 'bgiorgio6@nbcnews.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (8, 'EDP Services', '2020-09-11', 8, '55154-4962', 'ymarchent7@phpbb.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (9, 'Semiconductors', '2020-09-01', 9, '33261-847', 'cdecaroli8@rakuten.co.jp');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (10, 'Major Pharmaceuticals', '2019-11-15', 10, '15370-110', 'pcolhoun9@ucsd.edu');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (11, 'Major Banks', '2019-12-30', 11, '50441-0001', 'cziemsena@shareasale.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (12, 'Commercial Banks', '2020-07-03', 12, '33342-051', 'smaunderb@buzzfeed.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (13, 'EDP Services', '2019-11-04', 13, '13668-333', 'rcatenotc@about.me');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (14, 'Natural Gas Distribution', '2020-02-08', 14, '11559-043', 'blepined@dailymotion.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (15, 'Metal Fabrications', '2020-01-19', 15, '54569-4619', 'screaseye@ed.gov');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (16, 'Hotels/Resorts', '2020-08-23', 16, '41520-167', 'ttriggelf@wiley.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (17, 'Engineering & Construction', '2020-01-07', 17, '36987-1860', 'bruttyg@elegantthemes.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (18, 'Major Chemicals', '2020-01-06', 18, '57970-100', 'mkindredh@craigslist.org');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (19, 'Biotechnology: Biological Products (No Diagnostic Substances)', '2020-02-16', 19, '49349-981', 'dvarnhami@guardian.co.uk');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (20, 'Beverages (Production/Distribution)', '2019-12-24', 20, '17312-023', 'cshanksterj@w3.org');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (21, 'Mining & Quarrying of Nonmetallic Minerals (No Fuels)', '2020-05-19', 21, '43595-080', 'dnarracottk@goo.ne.jp');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (22, 'Pollution Control Equipment', '2019-10-08', 22, '46994-505', 'wcushellyl@discuz.net');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (23, 'Real Estate Investment Trusts', '2020-02-22', 23, '11673-994', 'felcumm@craigslist.org');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (24, 'n/a', '2020-08-31', 24, '52642-008', 'dswidenbankn@blog.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (25, 'Diversified Financial Services', '2019-12-03', 25, '51672-4142', 'colleto@cbc.ca');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (26, 'Major Pharmaceuticals', '2020-02-05', 26, '76296-009', 'nsawfordep@time.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (27, 'Marine Transportation', '2020-07-04', 27, '50436-4037', 'aphilimoreq@freewebs.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (28, 'Major Banks', '2020-04-06', 28, '13811-664', 'rvedikhovr@webmd.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (29, 'Industrial Machinery/Components', '2020-03-12', 29, '0093-0129', 'aabbisons@networkadvertising.org');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (30, 'Publishing', '2020-06-24', 30, '11084-113', 'ksighartt@rambler.ru');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (31, 'Electric Utilities: Central', '2020-05-30', 31, '22912-002', 'bbrasteadu@weather.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (32, 'Restaurants', '2020-04-01', 32, '59779-964', 'acarranev@reuters.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (33, 'Commercial Banks', '2019-11-17', 33, '76138-203', 'esmicklew@purevolume.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (34, 'Major Pharmaceuticals', '2020-07-25', 34, '0132-0323', 'bhaddyx@i2i.jp');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (35, 'Air Freight/Delivery Services', '2020-01-01', 35, '63014-1600', 'tbettlesy@arstechnica.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (36, 'Industrial Specialties', '2020-04-04', 36, '0603-0211', 'fbumpassz@omniture.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (37, 'Metal Fabrications', '2020-02-16', 37, '49349-646', 'cdeverell10@hao123.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (38, 'Investment Managers', '2020-03-25', 38, '0085-3320', 'dedds11@google.ca');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (39, 'Telecommunications Equipment', '2020-04-26', 39, '50268-513', 'wamiable12@cbc.ca');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (40, 'Mining & Quarrying of Nonmetallic Minerals (No Fuels)', '2020-08-09', 40, '49738-913', 'svandecastele13@issuu.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (41, 'Oil Refining/Marketing', '2019-11-28', 41, '55154-5380', 'mboyall14@home.pl');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (42, 'n/a', '2020-08-08', 42, '0378-7280', 'jdebroke15@cbc.ca');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (43, 'Electrical Products', '2019-10-04', 43, '16590-124', 'iadess16@networkadvertising.org');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (44, 'Major Banks', '2020-02-28', 44, '0472-1202', 'hmeeke17@sohu.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (45, 'Telecommunications Equipment', '2019-11-13', 45, '52125-452', 'cbausor18@hao123.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (46, 'Electrical Products', '2019-11-03', 46, '50436-3845', 'bbarefoot19@walmart.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (47, 'n/a', '2020-03-15', 47, '62742-4064', 'atregenza1a@biblegateway.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (48, 'Real Estate Investment Trusts', '2020-01-30', 48, '49348-880', 'tormiston1b@sohu.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (49, 'Major Pharmaceuticals', '2019-11-09', 49, '60512-1047', 'noffiler1c@tuttocitta.it');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (50, 'Major Pharmaceuticals', '2020-07-21', 50, '29149-001', 'jmougeot1d@go.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (51, 'EDP Services', '2020-04-11', 51, '54868-3334', 'jdimitrescu1e@ucoz.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (52, 'n/a', '2019-12-19', 52, '46122-223', 'geicke1f@archive.org');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (53, 'n/a', '2020-08-05', 53, '65044-0790', 'pmawer1g@blinklist.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (54, 'n/a', '2020-08-16', 54, '60512-6611', 'ghartman1h@opera.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (55, 'Major Banks', '2020-06-02', 55, '36987-1524', 'rcorsan1i@surveymonkey.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (56, 'Major Banks', '2020-03-25', 56, '68828-172', 'dgillbey1j@odnoklassniki.ru');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (57, 'RETAIL: Building Materials', '2020-02-14', 57, '65044-4083', 'ebarta1k@gravatar.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (58, 'n/a', '2020-07-26', 58, '0228-2539', 'hbloodworthe1l@t-online.de');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (59, 'Apparel', '2020-03-16', 59, '17518-857', 'ostieger1m@infoseek.co.jp');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (60, 'Biotechnology: Laboratory Analytical Instruments', '2020-09-17', 60, '37000-078', 'kcrevagh1n@csmonitor.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (61, 'Auto Manufacturing', '2020-02-05', 61, '57344-170', 'amcquilty1o@trellian.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (62, 'Auto Parts:O.E.M.', '2020-05-19', 62, '54575-170', 'fwickmann1p@etsy.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (63, 'n/a', '2020-03-01', 63, '0078-0610', 'mrylstone1q@umich.edu');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (64, 'Medical/Dental Instruments', '2019-10-22', 64, '0615-7842', 'nkuhle1r@sbwire.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (65, 'Major Pharmaceuticals', '2020-03-12', 65, '37205-302', 'wwhylie1s@constantcontact.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (66, 'Real Estate Investment Trusts', '2020-07-07', 66, '54868-6340', 'tburhouse1t@bloomberg.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (67, 'n/a', '2020-01-28', 67, '65162-194', 'zpallis1u@wikipedia.org');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (68, 'Oil & Gas Production', '2020-06-29', 68, '54569-0311', 'sbeaumont1v@so-net.ne.jp');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (69, 'n/a', '2020-01-29', 69, '50169-0004', 'aellison1w@thetimes.co.uk');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (70, 'Major Banks', '2020-09-24', 70, '63187-149', 'jwillmetts1x@goo.gl');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (71, 'Hotels/Resorts', '2019-11-19', 71, '0172-2083', 'pglaum1y@gov.uk');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (72, 'Real Estate Investment Trusts', '2019-12-02', 72, '36800-982', 'cnewlands1z@accuweather.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (73, 'Natural Gas Distribution', '2019-10-17', 73, '10481-1051', 'rroz20@nymag.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (74, 'Services-Misc. Amusement & Recreation', '2020-03-27', 74, '64942-1282', 'npeeters21@answers.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (75, 'Automotive Aftermarket', '2020-03-16', 75, '58668-1981', 'lbein22@paypal.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (76, 'Major Banks', '2020-01-26', 76, '15127-060', 'awraith23@squidoo.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (77, 'Power Generation', '2020-03-20', 77, '63868-164', 'mpetchell24@slashdot.org');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (78, 'Commercial Banks', '2019-12-12', 78, '68046-001', 'ctoolin25@unc.edu');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (79, 'Telecommunications Equipment', '2020-05-14', 79, '0268-1472', 'spogg26@arizona.edu');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (80, 'Diversified Commercial Services', '2019-10-19', 80, '37000-550', 'acahen27@stumbleupon.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (81, 'Publishing', '2020-04-18', 81, '42254-033', 'dmugridge28@clickbank.net');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (82, 'Finance: Consumer Services', '2019-11-16', 82, '55566-9500', 'vwynne29@indiegogo.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (83, 'Telecommunications Equipment', '2020-04-28', 83, '59746-330', 'hmcguiness2a@ft.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (84, 'Precious Metals', '2020-07-13', 84, '51672-5295', 'nhimsworth2b@spotify.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (85, 'Major Pharmaceuticals', '2020-01-24', 85, '55878-105', 'kmenezes2c@forbes.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (86, 'n/a', '2019-10-18', 86, '58836-0973', 'cgrzeszczyk2d@dailymotion.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (87, 'Investment Managers', '2020-02-12', 87, '60505-1323', 'ddorrins2e@rediff.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (88, 'Major Pharmaceuticals', '2020-05-09', 88, '36987-1277', 'gcrippin2f@engadget.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (89, 'Other Consumer Services', '2020-05-30', 89, '13668-039', 'aansteys2g@sitemeter.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (90, 'Major Chemicals', '2020-08-20', 90, '0051-0022', 'ellewelly2h@studiopress.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (91, 'Major Pharmaceuticals', '2020-02-29', 91, '63629-3294', 'eskehan2i@scientificamerican.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (92, 'Auto Parts:O.E.M.', '2020-01-29', 92, '53113-215', 'bbanasiak2j@vimeo.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (93, 'Investment Bankers/Brokers/Service', '2020-09-24', 93, '24909-106', 'emercer2k@wikispaces.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (94, 'Real Estate Investment Trusts', '2019-10-02', 94, '41250-909', 'hshellibeer2l@mapy.cz');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (95, 'Oilfield Services/Equipment', '2020-06-01', 95, '12027-102', 'lsmail2m@mayoclinic.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (96, 'Oil & Gas Production', '2020-08-02', 96, '59667-0026', 'gdownham2n@phoca.cz');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (97, 'Investment Bankers/Brokers/Service', '2020-01-17', 97, '55312-917', 'cpechet2o@wunderground.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (98, 'n/a', '2020-09-15', 98, '66116-255', 'dmcclaughlin2p@sbwire.com');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (99, 'n/a', '2019-10-10', 99, '0179-0157', 'qtallquist2q@ed.gov');
insert into bodega_1 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaImportadora, correoEmpresaImportadora) values (100, 'Property-Casualty Insurers', '2020-03-29', 100, '58118-5008', 'mclemerson2r@fastcompany.com');


DROP TABLE IF EXISTS bodega_2;
CREATE TABLE `bodega_2` (
  `IDBodega` VARCHAR(8) NOT NULL PRIMARY KEY,
  `nombreArticulo` varchar(50) NOT NULL,
  `fechaAlmacenamiento` date NOT NULL,
  `cantidad` int(10) NOT NULL,
  `nitEmpresaExportadora` varchar(15) NOT NULL,
  `celEmpresaExportadora` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;


insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (1, 'Beverages (Production/Distribution)', '2020-08-03', 1, '50484-302', '834-290-5674');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (2, 'Steel/Iron Ore', '2020-07-24', 2, '49817-0053', '923-550-7709');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (3, 'n/a', '2020-02-20', 3, '55154-3622', '837-477-0192');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (4, 'Air Freight/Delivery Services', '2019-12-23', 4, '65162-668', '944-402-7806');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (5, 'n/a', '2020-09-05', 5, '68682-995', '981-174-2351');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (6, 'Major Pharmaceuticals', '2020-04-29', 6, '59788-001', '283-270-9204');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (7, 'Real Estate Investment Trusts', '2019-12-18', 7, '0074-3288', '147-943-7644');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (8, 'n/a', '2020-09-15', 8, '54575-461', '279-669-3891');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (9, 'Farming/Seeds/Milling', '2020-07-14', 9, '37808-737', '635-193-3913');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (10, 'n/a', '2020-09-04', 10, '21695-066', '217-141-8001');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (11, 'Telecommunications Equipment', '2020-04-01', 11, '58411-131', '236-521-8538');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (12, 'Computer Software: Programming, Data Processing', '2020-07-18', 12, '16590-977', '101-263-5052');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (13, 'Investment Bankers/Brokers/Service', '2020-07-07', 13, '57520-0148', '589-204-9167');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (14, 'Specialty Foods', '2020-01-01', 14, '0781-6136', '118-295-6736');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (15, 'Industrial Specialties', '2020-07-19', 15, '0498-2101', '414-752-4009');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (16, 'n/a', '2019-12-02', 16, '0884-5192', '923-772-6160');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (17, 'n/a', '2020-05-10', 17, '0187-5144', '928-561-7147');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (18, 'Major Banks', '2020-07-07', 18, '57520-0624', '584-554-9478');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (19, 'Life Insurance', '2020-07-01', 19, '0409-5921', '200-154-9681');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (20, 'Building Products', '2020-06-23', 20, '58468-0040', '506-453-2546');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (21, 'Real Estate Investment Trusts', '2020-06-07', 21, '35356-589', '729-609-9852');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (22, 'Agricultural Chemicals', '2020-04-03', 22, '55648-743', '795-157-0819');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (23, 'n/a', '2019-12-15', 23, '11523-7206', '762-212-6247');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (24, 'n/a', '2020-02-06', 24, '51079-724', '216-542-3168');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (25, 'Computer Software: Prepackaged Software', '2020-08-22', 25, '50563-126', '963-950-5104');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (26, 'n/a', '2020-05-03', 26, '68084-284', '422-480-2511');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (27, 'Precision Instruments', '2019-12-22', 27, '0641-6136', '940-645-5873');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (28, 'n/a', '2019-11-28', 28, '49288-0259', '625-132-2012');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (29, 'Major Banks', '2020-02-29', 29, '49288-0693', '742-388-2393');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (30, 'n/a', '2020-01-16', 30, '55316-571', '593-565-9838');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (31, 'Major Pharmaceuticals', '2020-04-05', 31, '36987-2091', '372-729-4694');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (32, 'Semiconductors', '2020-02-18', 32, '68703-124', '608-344-6952');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (33, 'Office Equipment/Supplies/Services', '2020-08-17', 33, '66141-644', '604-346-9239');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (34, 'Home Furnishings', '2019-11-09', 34, '0135-0510', '983-706-2320');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (35, 'Computer Manufacturing', '2020-09-11', 35, '67938-1391', '444-576-6604');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (36, 'Oil/Gas Transmission', '2020-08-15', 36, '10812-416', '476-520-6345');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (37, 'n/a', '2020-05-21', 37, '58118-6240', '425-497-4419');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (38, 'n/a', '2020-01-28', 38, '68151-3838', '881-293-9998');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (39, 'Construction/Ag Equipment/Trucks', '2020-03-15', 39, '49035-206', '123-820-2220');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (40, 'Semiconductors', '2019-11-30', 40, '0093-5105', '828-761-1666');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (41, 'EDP Services', '2020-08-08', 41, '54868-5731', '767-445-8671');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (42, 'Oil & Gas Production', '2020-09-27', 42, '60681-1105', '953-524-0298');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (43, 'Electric Utilities: Central', '2019-12-05', 43, '49348-737', '648-529-3227');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (44, 'n/a', '2020-08-25', 44, '47593-496', '461-308-7169');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (45, 'Major Pharmaceuticals', '2020-05-09', 45, '11822-9009', '516-635-8761');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (46, 'n/a', '2019-11-13', 46, '11673-264', '663-666-4757');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (47, 'n/a', '2020-03-07', 47, '61442-122', '520-240-8041');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (48, 'n/a', '2020-06-24', 48, '54868-2847', '418-521-3854');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (49, 'Recreational Products/Toys', '2020-03-19', 49, '30142-180', '794-268-0328');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (50, 'Computer Software: Programming, Data Processing', '2020-05-21', 50, '0378-0734', '377-773-5356');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (51, 'Business Services', '2020-07-02', 51, '36987-1380', '717-465-1250');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (52, 'Television Services', '2020-07-06', 52, '66579-0018', '985-510-8704');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (53, 'n/a', '2020-09-21', 53, '62856-389', '737-166-6994');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (54, 'Miscellaneous manufacturing industries', '2019-10-08', 54, '55390-012', '198-620-8478');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (55, 'Home Furnishings', '2020-09-06', 55, '41616-221', '530-995-2673');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (56, 'Real Estate Investment Trusts', '2019-11-10', 56, '30142-047', '454-983-7609');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (57, 'Automotive Aftermarket', '2020-01-03', 57, '41190-668', '708-302-1674');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (58, 'Major Pharmaceuticals', '2020-03-30', 58, '50268-575', '817-433-6205');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (59, 'Semiconductors', '2020-04-19', 59, '11822-0384', '660-661-1705');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (60, 'Semiconductors', '2020-07-05', 60, '0944-2623', '764-631-6127');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (61, 'Real Estate Investment Trusts', '2020-03-18', 61, '44946-1014', '584-780-1228');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (62, 'Engineering & Construction', '2020-05-12', 62, '48951-7051', '827-577-9608');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (63, 'Major Pharmaceuticals', '2020-06-11', 63, '33992-8802', '907-181-5453');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (64, 'Marine Transportation', '2020-06-29', 64, '0135-0572', '728-465-1898');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (65, 'Computer Manufacturing', '2020-09-06', 65, '10056-964', '984-560-3840');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (66, 'Forest Products', '2020-04-22', 66, '49808-194', '678-193-4686');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (67, 'n/a', '2019-10-15', 67, '0113-0595', '135-618-4100');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (68, 'Other Consumer Services', '2019-12-03', 68, '43857-0276', '431-918-0117');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (69, 'n/a', '2019-11-03', 69, '59779-397', '249-768-9501');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (70, 'Hotels/Resorts', '2020-06-01', 70, '63739-539', '303-152-8624');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (71, 'Industrial Machinery/Components', '2020-08-30', 71, '63730-220', '701-631-2738');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (72, 'Newspapers/Magazines', '2019-10-13', 72, '63550-811', '193-387-4723');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (73, 'Major Banks', '2020-03-28', 73, '0904-6176', '371-733-3537');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (74, 'n/a', '2020-09-29', 74, '31722-270', '472-551-7184');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (75, 'Electronic Components', '2020-08-03', 75, '50600-003', '873-665-9040');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (76, 'Other Consumer Services', '2020-05-24', 76, '65044-2127', '236-223-2408');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (77, 'n/a', '2020-01-13', 77, '44911-0054', '856-520-8578');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (78, 'Telecommunications Equipment', '2019-12-22', 78, '50387-100', '833-404-6194');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (79, 'Transportation Services', '2020-04-01', 79, '67386-313', '488-498-6327');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (80, 'Savings Institutions', '2020-03-01', 80, '43419-857', '175-831-5377');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (81, 'Miscellaneous', '2019-12-15', 81, '11822-0117', '777-337-2769');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (82, 'Investment Bankers/Brokers/Service', '2020-04-05', 82, '46122-038', '797-194-3130');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (83, 'Steel/Iron Ore', '2020-09-24', 83, '43269-816', '207-125-1511');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (84, 'Restaurants', '2019-10-07', 84, '68308-219', '318-975-2206');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (85, 'Biotechnology: Commercial Physical & Biological Resarch', '2020-04-15', 85, '62839-0802', '347-381-2747');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (86, 'n/a', '2020-07-14', 86, '65044-3717', '191-967-2807');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (87, 'Professional Services', '2020-02-05', 87, '48951-3029', '937-891-9656');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (88, 'Beverages (Production/Distribution)', '2020-03-09', 88, '54868-4630', '968-233-1093');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (89, 'Restaurants', '2020-02-02', 89, '60758-773', '202-357-2002');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (90, 'Investment Managers', '2020-05-04', 90, '36000-028', '918-925-7701');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (91, 'Military/Government/Technical', '2020-08-28', 91, '63739-527', '533-409-3447');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (92, 'n/a', '2020-08-25', 92, '64980-170', '884-563-4595');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (93, 'Integrated oil Companies', '2020-02-05', 93, '36987-2353', '385-913-9931');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (94, 'n/a', '2020-08-29', 94, '0378-3340', '885-101-7369');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (95, 'Industrial Machinery/Components', '2020-07-12', 95, '68084-497', '638-525-6394');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (96, 'Oil & Gas Production', '2020-01-16', 96, '0517-4002', '837-447-5538');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (97, 'Real Estate Investment Trusts', '2019-12-26', 97, '35356-710', '993-963-0705');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (98, 'Real Estate Investment Trusts', '2019-12-06', 98, '51769-140', '860-905-3687');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (99, 'Finance: Consumer Services', '2020-01-06', 99, '51201-201', '694-350-3219');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (100, 'n/a', '2019-10-14', 100, '14222-1900', '850-926-7609');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (101, 'Major Banks', '2020-07-14', 101, '0009-0020', '790-979-4960');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (102, 'Investment Bankers/Brokers/Service', '2019-11-24', 102, '0268-0286', '866-703-3952');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (103, 'Telecommunications Equipment', '2019-11-27', 103, '0641-6007', '235-700-6967');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (104, 'n/a', '2020-06-06', 104, '0456-3407', '883-889-5252');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (105, 'n/a', '2020-02-03', 105, '36987-1932', '949-221-3953');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (106, 'Real Estate Investment Trusts', '2020-07-07', 106, '68419-0001', '128-624-3286');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (107, 'EDP Services', '2019-11-24', 107, '52773-243', '770-293-5370');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (108, 'Restaurants', '2020-04-29', 108, '0781-3224', '310-751-5423');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (109, 'Other Consumer Services', '2019-10-29', 109, '0019-3183', '458-169-4538');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (110, 'n/a', '2020-09-29', 110, '42389-001', '154-691-7326');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (111, 'Telecommunications Equipment', '2020-08-30', 111, '64661-091', '351-917-8671');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (112, 'Telecommunications Equipment', '2019-12-31', 112, '64942-1327', '800-581-8893');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (113, 'n/a', '2020-09-12', 113, '49035-798', '851-243-1956');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (114, 'Paper', '2020-03-20', 114, '0363-0525', '849-304-6612');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (115, 'n/a', '2020-09-19', 115, '47242-0201', '982-384-1269');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (116, 'Major Pharmaceuticals', '2020-07-12', 116, '68788-9716', '716-562-2197');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (117, 'Major Chemicals', '2020-02-24', 117, '0002-5800', '350-730-2332');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (118, 'Hotels/Resorts', '2020-07-07', 118, '43269-842', '798-138-1703');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (119, 'Transportation Services', '2020-04-26', 119, '0187-5170', '421-275-1601');
insert into bodega_2 (IDBodega, nombreArticulo, fechaAlmacenamiento, cantidad, nitEmpresaExportadora, celEmpresaExportadora) values (120, 'Business Services', '2020-06-28', 120, '35418-232', '310-683-2807');
